...
const About = () => {
  return (
    <div id="about" className="w-full px-6 md:px-12 lg:px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-4 mt-3">
        <div className=" flex w-full lg:w-[70%] lg:top-3 flex-col items-center lg:items-start justify-center mt-8 lg:mt-0">
          <div className=" border w-40 sm:w-64 md:w-80 rounded-3xl max-w-none flex justify-center ">
            <Image
        ...
        <div className="flex border w-full flex-col lg:justify-start lg:items-start justify-center items-center gap-6 mt-5">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <div className="border p-2 rounded-lg  hover:scale-105">
